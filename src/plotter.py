# Used sklearn tutorial code for reference to generate multiclass roc
...
def plot_roc(y_test, y_score, clf_name):
	...
	for i in range(n_classes):
	    fpr[i], tpr[i], temp = roc_curve(y[:, i], y_score[:, i])
...
# Used sklearn tutorial code forr reference to annotate confusion matrix 
